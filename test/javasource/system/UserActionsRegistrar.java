...
public class UserActionsRegistrar implements EventHandler
{
	...
	public void handleEvent(Event event)
	{
		if (event.getTopic().equals(com.mendix.core.event.EventConstants.ModelLoadedTopic()))        
		{
			...
			component.actionRegistry().registerUserAction(demo.actions.Delay.class);
			component.actionRegistry().registerUserAction(realprogress.actions.GetProgress.class);
			component.actionRegistry().registerUserAction(realprogress.actions.GetProgressMessage.class);
			component.actionRegistry().registerUserAction(realprogress.actions.SetProgress.class);
			component.actionRegistry().registerUserAction(realprogress.actions.SetProgressMax.class);
