		...
		*/
			...
			if (this.contextObj && this.mfToExecute !== "") {
				mx.data.action({
					...
					callback : dojoLang.hitch(this, function (objs) {
						...
						//this.myProgressBar.set("text", objs[0].get(this.messageattr));
						if (progress < 100 && this.count < 30) {
							//clearTimeout(this.timeout);
							//this.timeout = setTimeout(dojoLang.hitch(this, this.callMF()), 20000);
						} else {
							this._stopTimer();
        ...
        _runTimer: function () {
            ...
            if (this.mfToExecute !== "" && this.contextObj) {
                ...
                this._timer = setInterval(dojoLang.hitch(this, this.callMF), 5000);
            }
        },
